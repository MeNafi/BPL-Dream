...
const SelectedCard = ({player}) => {
    ...
    return (
     ...
     <div className="flex items-center">
        <img src= {player["player-image"]} className="h-[50px] w-[50px] rounded-lg" alt="" />
     ...
     <div className="ml-2">
      ...
      <div>
      <img className="w-5 h-5" src="https://i.ibb.co.com/5xMKcMxD/delete.png" alt="delete vector icon" />
      </div>
      </div>
    );
};
